<template>
    <div>
        ...
        <el-table ref="multipleTable" :data="userData" tooltip-effect="dark" style="width: 100%"
            ...
            <el-table-column align="center" prop="userid" label="编号" width="90"></el-table-column>
            <el-table-column align="center" prop="time" label="入住时间" width="120"></el-table-column>
            <el-table-column align="center" prop="platform" label="平台" width="90"></el-table-column>
            <el-table-column align="center" prop="romno" label="房间号" width="80"></el-table-column>
            <el-table-column align="center" prop="name" label="入住人" width="90"></el-table-column>
            <el-table-column align="center" prop="romtype" label="房型" width="80"></el-table-column>
            <el-table-column align="center" prop="paymoney" label="实付金额" width="90"></el-table-column>
            <el-table-column align="center" prop="money" label="到账金额" width="90"></el-table-column>
            <el-table-column align="center" prop="brokerage" label="备注" width="180"></el-table-column>
            <el-table-column align="center" prop="day" label="入住时长" width="90"></el-table-column>
            <el-table-column align="center" prop="classes" label="班次" width="80"></el-table-column>
            <el-table-column align="center" prop="person" label="值班人" width="90"></el-table-column>
